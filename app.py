...
def render_calendar_tab():
    ...
    # [수정] 월간 현황은 Schedules DB만 사용 (기존 유지)
                ...
                with cols[i]:
                    if day == 0: st.write("")
                        ...
                        if not w_row.empty:
                            ...
                            # [수정] 텍스트 잘림 방지 (white-space: normal)
                            ...
                            if is_reduction_target(d_str, "", "", red_rules): # 고정차 정보가 없어서 날짜기준 체크
